...
export function LandingContent() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white overflow-hidden">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-zinc-950/70 backdrop-blur-xl border-b border-white/[0.04]">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/register"
              className="rounded-lg bg-violet-600 px-4 py-2 text-sm font-medium transition hover:bg-violet-500 shadow-lg shadow-violet-600/20"
            >
              免费注册
            </Link>
          </div>
