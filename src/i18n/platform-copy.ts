...
const zh = {
  ...
  auth: {
    ...
    demo: "使用演示账号体验",
    sessionHint: "7 天内保持登录 · 期间有活动会自动续期 · 账号问题请联系管理员",
    sessionExpired: "登录状态已过期（连续 7 天没有活动），重新登录后会回到你刚才的位置。",
    noAccount: "还没有账号？",
  ...
  create: {
    ...
    generateHint: "生成前会自动完成方案检查；如需查看分镜，可先预览方案。",
  },
  images: {
    kicker: "产品图工作台",
    ...
    cancelledTitle: "这一轮已取消",
    cancelledBody: "取消永远免费。已产出的图片仍在历史里，随时可以用同样的输入重新生成。",
    ...
    preview: "成品预览",
    approved: "已通过安全检查 · 已存入下方产品图库",
    useSingle: "用于单条视频",
    useBatch: "用于批量视频",
    download: "下载",
    downloading: "正在下载…",
    downloadFailed: "下载失败，已在新标签页打开图片。",
    variation: "换个构图",
    editAgain: "接着改这张",
    nextStepHint: "满意就下载留用，或直接把这张图带进视频生产；想继续调整可以「接着改这张」。",
    failed: "本次处理未完成",
    emptyTitle: "还没有产品图",
    emptyBody: "选择优化实拍图或生成产品图，成品可直接进入单条与批量视频流程。",
    historyKicker: "产品图库",
    historyTitle: "你的产品图库",
    historySubtitle: "这里保存你生成过的每一张产品图，随时可以下载、继续修改或带进视频生产。",
    historyEmpty: "完成第一张产品图后，它会保存在这里，随时可复用。",
  ...
  batches: {
    ...
    monitor: {
      ...
      retryRecoverable: "重试可恢复任务",
      cancelUnstarted: "取消未开始",
      paused: "生成服务暂时拥堵，剩余 {count} 条已安全暂停。熔断恢复后会自动续跑。",
      refreshFailed: "暂时无法刷新批次状态。",
      actionFailed: "暂时无法完成该操作。",
      statusUpdated: "批次状态已更新",
      total: "总数",
      completed: "完成",
      running: "进行中",
      queuedPaused: "排队/暂停",
      failed: "失败",
      progress: "批次总进度",
      virtualized: "虚拟列表仅渲染可视区域",
      currently: "当前",
      items: "条",
      clearSelection: "取消全选",
      selectCompleted: "全选已完成",
      ...
      nextStep: "处置说明",
      retryVideo: "单条重试",
      jobStatuses: { QUEUED: "排队中", PAUSED: "已暂停", RUNNING: "生成中", SUCCEEDED: "已完成", FAILED: "失败", CANCELLED: "已取消" },
      failures: {
        providerTimeout: "生成等待超时。",
        providerError: "视频生成失败。",
        assetMissing: "原始素材已失效或无法读取。",
        acknowledgementUnknown: "生成状态尚未确认。",
      },
    },
  },
  racing: {
...
const en: CopyShape<typeof zh> = {
  ...
  auth: {
    studio: "Video Production Studio", kicker: "AI VIDEO PRODUCTION STUDIO", titleLead: "From one idea,", titleAccent: "to reliable delivery.", subtitle: "Plan, template, generate, quality-check, and deliver batches in one traceable production line.", workflow: "Workflow", trace: "Trace", output: "Output", privacy: "Privacy", terms: "Terms", loginTitle: "Welcome back to the studio", loginDescription: "Sign in to Aivora and continue your next short video.", email: "Email", password: "Password", passwordPlaceholder: "Enter password", login: "Sign in", loggingIn: "Signing in", preparingStudio: "Opening your studio…", demo: "Try the demo account", sessionHint: "Stay signed in for 7 days · Activity keeps renewing it · Contact an administrator for account help", sessionExpired: "Your session expired after 7 days without activity. Sign in again and you will land back where you were.", noAccount: "New to Aivora?", createAccount: "Create an account", invalidCredentials: "Incorrect email or password", registerTitle: "Create your Aivora account", registerDescription: "Create a workspace and start from a quality-locked template.", displayName: "Display name (optional)", displayNamePlaceholder: "How should we address you?", newPassword: "Password (8+ characters)", newPasswordPlaceholder: "Enter at least 8 characters", creating: "Creating", create: "Create account", hasAccount: "Already have an account?", loginNow: "Sign in", randomnessNote: "By registering, you acknowledge that AI-generated content may vary slightly.", registerFailed: "Could not create the account. Try again.", autoLoginFailed: "Account created, but automatic sign-in failed. Please sign in manually.", networkError: "Network error. Try again.",
  },
  create: {
    ...
    generateHint: "A quality check runs automatically before dispatch. Preview the shot list first only when you want to inspect it.",
  },
  images: {
    kicker: "PRODUCT IMAGE STUDIO", pageTitle: "Get the product image right, then scale video", pageSubtitle: "Optimize a real photo or generate a new product visual. Presets lock composition and lighting, then hand the result to single or batch video.", workbench: "Product image workbench", optimize: "Optimize photo", generate: "Generate product image", replace: "Click to replace · 20MB max",
  ...
  batches: {
    ...
    monitor: {
      ...
      retryRecoverable: "Retry recoverable",
      cancelUnstarted: "Cancel unstarted",
      paused: "Generation is temporarily congested. {count} items are safely paused and will resume when the circuit breaker recovers.",
      refreshFailed: "Batch status is temporarily unavailable.",
      actionFailed: "This action could not be completed.",
      statusUpdated: "Batch status updated",
      total: "Total",
      completed: "Completed",
      running: "Running",
      queuedPaused: "Queued / paused",
      failed: "Failed",
      progress: "Batch progress",
      virtualized: "Virtualized view renders only visible rows",
      currently: "Currently",
      items: "items",
      clearSelection: "Clear selection",
      selectCompleted: "Select completed",
      downloadSelected: "Download selected",
      jobsLabel: "Batch video jobs",
      video: "Video",
      ready: "Ready to play and download",
      cancelled: "Cancelled before generation",
      retryCount: "retries",
      retry: "Retry",
      nextStep: "Next step",
      retryVideo: "Retry video",
      jobStatuses: { QUEUED: "Queued", PAUSED: "Paused", RUNNING: "Generating", SUCCEEDED: "Completed", FAILED: "Failed", CANCELLED: "Cancelled" },
      failures: {
        providerTimeout: "Generation timed out.",
        providerError: "Video generation failed.",
        assetMissing: "The source asset is missing or unavailable.",
        acknowledgementUnknown: "Generation status has not been confirmed.",
      },
    },
  },
