    ...
    <section id="investor" className="relative overflow-hidden bg-background">
      <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-10">
        ...
        <dl className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {s.metrics.map((m) => (
            <div key={m.label} className="border border-border bg-card shadow-editorial rounded-(--radius-lg) p-5">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          {s.pillars.map((p) => (
            <div key={p.title} className="border border-border bg-card shadow-editorial rounded-(--radius-lg) p-6">
