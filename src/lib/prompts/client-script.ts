...
- 行业合规：
  ...
  - home_goods / home_decor: 强调真实使用场景；不暗示安全/医疗/保险等收益；如素材来自品牌方需声明。
...
function complianceNotesFor(industry: ClientBrief["industry"]) {
  switch (industry) {
    ...
    case "home_decor":
      return [
        "Show product in real-life setting; avoid before/after claims that imply medical, safety, or insurance benefits.",
        "Disclose any sponsored / paid placement if the footage was provided by a brand partner.",
      ];
    default:
      return [];
  }
