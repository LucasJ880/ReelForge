# Aivora Real-Footage Ads 60s Demo Video

## Video objective

Create a polished 60-second SaaS-style walkthrough video for the `/demo/real-footage-ads` landing page hero. The video should help non-technical customers and early investors understand what Aivora Real-Footage Ads does, why it matters, and how the workflow turns messy real footage into a repeatable creative testing loop.

The video is a product walkthrough and positioning asset. It should not imply mature automation beyond the current MVP, and it should not claim proven performance lift.

## Target audience

- Small business owners with real product, store, food, service, or UGC footage.
- DTC, local service, and creator-commerce teams that need more short-form ad variants.
- Agencies that manage many low-budget creative tests for clients.
- Early investors evaluating whether Aivora has a clear wedge beyond generic AI video generation.

## Core message

Aivora turns messy real product footage into multiple testable short-form ad concepts, renders a 9:16 video, and learns from performance data to generate the next round.

Supporting message:

- Most customers already have raw footage.
- The bottleneck is turning that footage into structured, testable ad variants.
- Aivora creates a repeatable loop: upload, index, generate concepts, review, render, import metrics, improve the next round.
...
### Scene 1: Problem hook, 0-5s

Visual:
Dark SaaS background. Several messy phone-shot product clips float in a loose grid: a local store shelf, a cafe counter, a small product close-up, a service business lobby, and a hand-held UGC-style product shot. Clips feel real and imperfect, with mild shake, uneven lighting, and different aspect ratios.
...
Visual:
A vertical 9:16 video preview appears inside the dashboard. It shows realistic product/store footage, clean captions, a simple CTA, and a progress state changing from `Rendering` to `Ready`. Keep the ad preview generic and brand-free.

Camera:
Slow dolly toward the vertical preview. The render progress completes with a restrained success state.

Overlay:
“Render 9:16 ads ready for testing.”

Prompt:
Vertical 9:16 short-form ad preview rendering inside SaaS dashboard, realistic product footage, clean captions, simple CTA, progress bar completes, polished but not flashy, dark interface, teal highlights, high-quality B2B SaaS product video, no logos, no brand names.
...
- “Messy footage in.”
- “5 testable ad concepts out.”
- “AI review before publishing.”
- “Render 9:16 short-form ads.”
- “Learn from metrics.”
...
Small businesses already have the footage. What they do not have is a fast way to turn it into ads they can test.

Aivora organizes raw clips into usable shots, generates five ad concepts, reviews them with AI, and renders short-form videos ready for testing.

After publishing, metrics come back into the system, so the next round gets smarter.

Bring your own messy footage, and see what Aivora can create.

## Suggested B-roll / screen recording shots

- Raw phone footage montage: product close-ups, storefront clips, food prep, service detail, customer or pet reaction.
- `/demo/real-footage-ads` hero section with the product positioning.
- Upload UI mockup with multiple video files.
- Shot index UI with thumbnails, tags, and quality notes.
- Five ad plan cards from the public demo page.
- AI Reviewer scorecard with overall score, strengths, improvement suggestions, and dimensions.
- Rendered 9:16 MP4 preview.
- Metrics recap panel with winner angle and next-round suggestion.
- Waitlist CTA section: “Bring your own messy footage.”

## Music / pacing direction

- Modern light electronic soundtrack.
- Confident, clean, startup SaaS tone.
- Medium tempo, around 90-110 BPM.
- Avoid aggressive hype, heavy drops, or cinematic trailer intensity.
- Use subtle UI clicks, soft whooshes, and gentle success tones for transitions.
- Keep the voiceover clear and slightly warmer than a technical product demo.

Pacing:

- 0-12s: Problem and input should feel quick and familiar.
- 12-35s: Slow down slightly so viewers understand the product workflow.
- 35-53s: Build confidence by showing render output and feedback loop.
- 53-60s: End cleanly on the CTA, with no extra claims.
...
Secondary CTA for landing page caption:

“Aivora turns real product footage into testable ad concepts, rendered videos, and the next round of creative recommendations.”

## Seedance-ready master prompt

Create a 60-second modern SaaS product walkthrough video for Aivora Real-Footage Ads.

Style: premium B2B SaaS, dark interface, clean neon teal accents, smooth UI transitions, realistic product dashboard mockups, cinematic but not flashy, product-led, confident, clear, non-technical, suitable for small business customers and early investors.

Narrative: Small businesses already have messy real product footage, but turning it into multiple testable ads is slow, expensive, and inconsistent. Aivora helps them upload raw footage, organize it into reusable shots, generate 5 ad concepts, review each concept with AI scoring, render a vertical 9:16 short-form ad, and learn from performance metrics to generate the next round. Avoid overclaiming. Do not show fake performance lift. Do not show copyrighted logos. Do not use real brand names unless they are neutral placeholders.
...
Music mood: modern light electronic, clean, confident, premium SaaS, no aggressive hype.
...
## Notes for embedding the finished video

Recommended implementation after the video is generated:

1. Upload the finished 16:9 walkthrough video to the existing blob/video hosting path.
2. Add `DEMO_WALKTHROUGH_VIDEO_URL` as an environment variable.
3. Use `DEMO_WALKTHROUGH_VIDEO_URL` in `/demo/real-footage-ads` as the hero/demo video.
4. Keep the existing exported sample MP4 lower on the page as the case study proof video.
5. Keep the walkthrough video focused on explanation, and keep the exported sample MP4 focused on proof that the MVP can render real 9:16 output.

Suggested fallback behavior:

- If `DEMO_WALKTHROUGH_VIDEO_URL` is not set, keep showing the existing demo seed MP4.
- Once the walkthrough is live, update the hero label from “Exported sample MP4” to “60-second product walkthrough.”

Suggested 9:16 cutdown:

- Reuse the same scene order.
- Crop UI mockups tighter around the upload area, ad concept cards, vertical render, and CTA.
- Keep overlays shorter:
  - “Messy footage in.”
  - “5 ad concepts out.”
  - “Render 9:16 ads.”
  - “Learn from metrics.”
...
## Final Seedance execution package

Use this section when generating the final video. These prompts are copy-paste-ready and include the production constraints needed for the landing page asset.

### Prompt 1: 16:9 landing page hero version

```text
Create a 60-second modern SaaS product walkthrough video for Aivora Real-Footage Ads.

Output format: 16:9 landscape, landing page hero video, high quality, approximately 60 seconds. Design it for a public SaaS landing page hero, not a social ad. The video should feel premium, clear, product-led, and understandable by non-technical small business customers and early investors.

Visual style: premium B2B SaaS, dark interface, clean neon teal accents, smooth UI transitions, realistic product dashboard mockups, subtle glassmorphism panels, crisp typography, cinematic but not flashy. Use clean screen-like UI mockups and realistic small business footage. Avoid chaotic cuts, exaggerated effects, or hype-heavy visuals.

Narrative: Small businesses already have messy real product footage, but turning it into multiple testable ads is slow, expensive, and inconsistent. Aivora helps them upload raw footage, organize it into reusable shots, generate 5 ad concepts, review each concept with AI scoring, render a vertical 9:16 short-form ad, and learn from performance metrics to generate the next round.
...
Music mood: modern light electronic, confident, clean, premium SaaS, medium tempo around 90-110 BPM. No aggressive hype, heavy drops, or trailer-style intensity.
...
```text
Create a 45-60 second vertical social cutdown for Aivora Real-Footage Ads.

Output format: 9:16 vertical, high quality, optimized for social preview and mobile viewing. Use the same product story as the landing page hero, but crop tightly around the most important UI moments so text is readable on a phone.

Visual style: premium B2B SaaS, dark interface, clean neon teal accents, smooth UI transitions, realistic dashboard mockups, crisp mobile-friendly typography, confident and clean. Keep it product-led and clear, not flashy or hype-heavy.

Narrative: Small businesses already have messy real product footage. Aivora turns that footage into reusable shots, generates 5 testable ad concepts, reviews them with AI scoring, renders a vertical short-form ad, and uses metrics to recommend the next creative round.

Scene flow and timing:

0-5s: Tight vertical composition of messy phone-shot product clips stacked and floating: product close-up, store clip, service detail, customer/pet reaction. Overlay: “Messy footage in.”

5-11s: Show upload dashboard cropped tightly around the drag-and-drop upload panel. Raw clips appear with neutral placeholder file names. Overlay: “Upload your product clips.”

11-20s: Show shot index thumbnails and tags filling the vertical frame. Highlight usable moments and best opening shots. Overlay: “Aivora finds the usable moments.”

20-32s: Show 5 ad concept cards in a vertical scroll or stacked card layout. Each card includes hook, audience, CTA, and AI score. Keep the UI customer-readable and avoid raw JSON. Overlay: “5 testable ad concepts out.”

32-42s: Show a vertical 9:16 ad preview rendering inside the product UI. Include captions, product/store footage, and a simple CTA. Overlay: “Render 9:16 ads.”

42-51s: Show a compact metrics panel with neutral placeholder metrics, winning angle, and next-round recommendation. Overlay: “Learn from metrics.”

51-60s: End on a mobile-friendly landing page CTA. Overlay: “Request demo access.”

Camera movement: vertical-friendly push-ins, smooth card scrolls, gentle zooms, subtle parallax, clean transitions. Keep UI text large enough to read.

Music mood: modern light electronic, clean, confident, SaaS-style, no aggressive hype.

Voiceover:
“Small businesses already have the footage. Aivora turns raw clips into usable shots, generates five ad concepts, reviews them with AI, and renders short-form videos ready for testing. When metrics come back, Aivora recommends the next round. Bring your own messy footage and request demo access.”

Constraints: no copyrighted logos, no TikTok logo, no platform logo lockups, no real brand names, no fake customer names, no fake performance lift claims, no exaggerated ROI claims, no claims that publishing is fully automated. Use placeholder UI data only.
```
...
- `/demo/real-footage-ads` hero section with the headline and current demo video area.
- Customer ad results section showing the 5 generated ad plan cards.
- A close pass over one ad plan timeline preview with timestamps, thumbnail, and overlay text.
- AI Reviewer output section with overall score, strengths, improvement suggestions, and scoring dimensions.
- Before / after case study section.
- Proof dashboard section showing traction signals.
- Waitlist / request demo section.

Existing sample MP4 to include:

- Use the current `DEMO_SEED_VIDEO_URL` exported pet-store sample MP4 as the proof/case-study video.
- Current source: `https://jke9jtodu89xlpcy.public.blob.vercel-storage.com/demo-seed/pet_store_chinese_demo_30s_no_text_bgm_v2.mp4`
- Use it briefly in the walkthrough render scene if helpful, but keep its main role as the lower-page proof video after integration.

UI sections to show:

- Upload / raw footage intake mockup.
- Shot index with thumbnails, tags, and usable moments.
- 5 ad concept cards.
- AI Reviewer scorecard.
- 9:16 render preview.
- Metrics recap / winner angle / next-round suggestion.
- Waitlist CTA.

What not to show:

- Raw JSON, database records, Prisma, route handlers, logs, terminal output, or admin-only implementation details.
- TikTok logos, platform logos, copyrighted brand marks, or real customer names.
- Fake performance lift, ROI claims, guaranteed conversion claims, or growth charts implying proven campaign results.
- Fully automated publishing claims.
- Complex timeline editor UI, TTS workflow, avatar workflow, or heavy video architecture that is not part of the current MVP story.

Export settings:

- Landing page hero: `MP4`, H.264, 16:9, 1920x1080, 60 seconds or less, 24 or 30 fps, web-optimized.
- Social cutdown: `MP4`, H.264, 9:16, 1080x1920, 45-60 seconds, 24 or 30 fps, web-optimized.
- Audio: AAC, modern light electronic bed, clear voiceover, normalized for web playback.
- Suggested file names:
  - `aivora-real-footage-ads-walkthrough-60s-16x9.mp4`
  - `aivora-real-footage-ads-walkthrough-social-9x16.mp4`
  - `aivora-real-footage-ads-walkthrough-60s-16x9-poster.jpg`

## Post-generation implementation note
...
2. Add `DEMO_WALKTHROUGH_VIDEO_URL` to the environment with the uploaded video URL.
3. Optionally add a poster image env var later, such as `DEMO_WALKTHROUGH_VIDEO_POSTER_URL`, if a custom poster is produced.
4. Update `/demo/real-footage-ads` so the Hero video uses `DEMO_WALKTHROUGH_VIDEO_URL`.
5. Keep `DEMO_SEED_VIDEO_URL` lower on the page as the proof/case-study rendered MP4.
6. Add graceful fallback logic: if `DEMO_WALKTHROUGH_VIDEO_URL` is not configured, continue showing `DEMO_SEED_VIDEO_URL` in the Hero.
7. Update the Hero label when the walkthrough is configured:
   - With walkthrough: “60-second product walkthrough”
   - Without walkthrough fallback: “Exported sample MP4”

Recommended code shape for the later page change:

```ts
const walkthroughVideoUrl = process.env.DEMO_WALKTHROUGH_VIDEO_URL;
const heroVideoUrl = walkthroughVideoUrl || DEMO_SEED_VIDEO_URL;
const heroVideoLabel = walkthroughVideoUrl
