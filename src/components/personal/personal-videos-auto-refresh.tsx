...
export interface PersonalVideoPollTarget {
  briefId: string;
...
/**
 * While any personal video is in-flight, poll render-status so local dev
 * does not depend on Vercel cron (Phase 4 real E2E).
 */
export function PersonalVideosAutoRefresh({
  targets,
}: {
  targets: PersonalVideoPollTarget[];
}) {
